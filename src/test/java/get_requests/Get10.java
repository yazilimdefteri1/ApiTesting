...
public class Get10 extends GoRestBaseUrl {
    ...
    "data": {
        "id": 2965,
        "name": "Chandran Abbott Sr.",
        "email": "sr_abbott_chandran@hane.info",
        "gender": "male",
        "status": "active"
    }
                  }
    ...
    public void get01(){
        ...
        Map<String , String> dataKeyMap = dataKey.dataKeyMap("Chandran Abbott Sr.", "sr_abbott_chandran@hane.info","male","active");//İç Map'i oluşturuyorum.
